...
public class CustomListMultiOptions extends ArrayAdapter<DataInProduct.OptionsValues> {
    private Activity Activity;
    private ArrayList<DataInProduct.OptionsValues> Data;
    private DisplayImageOptions options;

    public CustomListMultiOptions(Activity context, ArrayList<DataInProduct.OptionsValues> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (Data.get(position).value.isEmpty()) {
            Data.get(position).value = "0";
        }
        txtName.setText(Data.get(position).value.trim() + "");

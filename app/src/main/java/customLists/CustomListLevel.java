...
public class CustomListLevel extends ArrayAdapter<DataInCatsLevels.Category> {
    private Activity Activity;
    private ArrayList<DataInCatsLevels.Category> Data;
    private DisplayImageOptions options;

    public CustomListLevel(Activity context, ArrayList<DataInCatsLevels.Category> data) {
        super(context, R.layout.singel_cats_levels_list, data);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        options = new DisplayImageOptions.Builder()
                ...
                .build();
        ImageLoader.getInstance().displayImage(Values.Link_ImageInnerCats + Data.get(position).image, Image, options);
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                Data = (ArrayList<DataInCatsLevels.Category>) results.values;
                notifyDataSetChanged();
            }

            @Override
            protected FilterResults performFiltering(CharSequence constraint) {
                ArrayList<DataInCatsLevels.Category> filteredResults = getFilteredResults(constraint);
    ...
    private ArrayList<DataInCatsLevels.Category> getFilteredResults(CharSequence constraint) {

...
public class CustomListCartCheckout extends ArrayAdapter<DataInCartCheckout.Products> {
    private Activity Activity;
    private ArrayList<DataInCartCheckout.Products> Data;
    private DisplayImageOptions options;

    public CustomListCartCheckout(Activity context, ArrayList<DataInCartCheckout.Products> data) {
        super(context, R.layout.singel_cart_checkout_list, data);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.singel_cart_checkout_list, null, true);
        TextView txtTitle = rowView.findViewById(R.id.tv_Title);
        TextView tv_Type = rowView.findViewById(R.id.tv_Type);
        TextView tv_Seller = rowView.findViewById(R.id.tv_Seller);
        ...
        txtTitle.setText(Data.get(position).title_en);
        txtAmount.setText(Activity.getResources().getString(R.string.Amount) + " : " + Data.get(position).count + " ");
        tv_Seller.setText(Data.get(position).store_name + "");
        ...
        if (Float.parseFloat(Data.get(position).price_before_offer) == 0) {
            ...
            if ((d - (int) d) != 0)
                tv_discount.setText(Activity.getResources().getString(R.string.Discount) + " - " + Data.get(position).offer_percentage + " %");
            else
                tv_discount.setText(Activity.getResources().getString(R.string.Discount) + " - " + (int) Math.round(Data.get(position).offer_percentage) + " %");
        }
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                Data = (ArrayList<DataInCartCheckout.Products>) results.values;
                notifyDataSetChanged();
            }

            @Override
            protected FilterResults performFiltering(CharSequence constraint) {
                ArrayList<DataInCartCheckout.Products> filteredResults = getFilteredResults(constraint);
    ...
    private ArrayList<DataInCartCheckout.Products> getFilteredResults(CharSequence constraint) {

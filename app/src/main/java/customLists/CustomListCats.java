...
public class CustomListCats extends ArrayAdapter<DataInAllCats.Cats> {
    private Activity Activity;
    private ArrayList<DataInAllCats.Cats> Data;
    private DisplayImageOptions options;

    public CustomListCats(Activity context, ArrayList<DataInAllCats.Cats> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        options = new DisplayImageOptions.Builder()
                ...
                .build();
        ImageLoader.getInstance().displayImage(Values.Link_ImageHomeCats + Data.get(position).image, Image, options);

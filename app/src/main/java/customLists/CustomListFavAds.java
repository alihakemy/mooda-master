...
public class CustomListFavAds extends ArrayAdapter<DataInFavAds.Product> {
    private Activity Activity;
    private ArrayList<DataInFavAds.Product> Data;
    private DisplayImageOptions options;

    public CustomListFavAds(Activity context, ArrayList<DataInFavAds.Product> data) {

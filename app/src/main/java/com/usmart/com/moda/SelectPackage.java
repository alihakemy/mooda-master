...
public class SelectPackage extends Activity {
    ...
    Activity activity = SelectPackage.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MainTitle.setText(R.string.BalancePackage);
    ...
    private void loadData() {
        ...
        Url = Values.Link_service + "balance_packages/" + lang + "/v1";
        Log.i("TestApp", Url);
        ...
        client.get(Url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int arg0, String arg1) {
                ...
                try {
                    ...
                    if (_Data.data.packages.size() > 0) {
                        adapter2.addAll(_Data.data.packages);
                        adapter2.notifyDataSetChanged();

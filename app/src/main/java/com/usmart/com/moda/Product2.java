...
public class Product2 extends FragmentActivity {
    Activity activity = Product2.this;
    ...
    EditText edit_Desc, Tall, Shoulder, Chest, Waist, Buttocks , Sleeve;
    ProgressBar prog;
    Button btn_Buy;
    ...
    int ID;
    int SelectedOptID = 0;
    ExpandableHeightGridView lvOptions;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Buttocks = findViewById(R.id.Buttocks);
    ...
    private void AddCart(int ID) {
        ...
        if (Tall.getText().toString().matches("")
                || Shoulder.getText().toString().matches("") || Chest.getText().toString().matches("")
                || Waist.getText().toString().matches("") || Buttocks.getText().toString().matches("")
                || Sleeve.getText().toString().matches("")) {
        ...
        if (Data.data.product.multi_options == 1) {
            json = new StringBuilder()
                    ...
                    .append("\"tall\":\"" + Tall.getText().toString() + "\",")
                    .append("\"shoulder_width\":\"" + Shoulder.getText().toString() + "\",")
                    .append("\"chest\":\"" + Chest.getText().toString() + "\",")
                    .append("\"waist\":\"" + Waist.getText().toString() + "\",")
                    .append("\"buttocks\":\"" + Buttocks.getText().toString() + "\",")
                    .append("\"sleeve\":\"" + Sleeve.getText().toString() + "\",")
                    .append("\"details\":\"" + edit_Desc.getText().toString() + "\",")
                    // .append("\"product_number\":\"" + tv_amount.getText().toString() + "\"")
                    .append("\"product_number\":\"" + 1 + "\"")
                    .append("}").toString();
        } else {
            json = new StringBuilder()
                    .append("{")
    ...
    public void gotoShare(View v) {
        ...
        intent.putExtra(Intent.EXTRA_TEXT, "http://onelink.to/hela");
